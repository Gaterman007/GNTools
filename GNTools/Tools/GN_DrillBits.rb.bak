...
module GNTools
	...
	class DrillBits
		...
		def self.load_drillBitsTbl
			@@drillbitTbl.push(DrillBit.new("Default","Up",3.175,"mm",3.175,3.175,22,3.175,0,2,0))
			@@drillbitTbl.push(DrillBit.new("#2","Down",3.175,"mm",3.175, 3.175,22,3.175,0,2,0))
			@@drillbitTbl.push(DrillBit.new("#3","Up",6,"mm",6,6,13,57,0,2,0))
			@@drillbitTbl.push(DrillBit.new("#4","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#7","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#7","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#7","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#5","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#9","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#6","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#8","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#10","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#13","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#11","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#12","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#15","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			@@drillbitTbl.push(DrillBit.new("#14","Down",5,"mm",43.4,2.10,1.1,9.4,22.10,6.3,7.10))
			nil
		end
...
#					@@drillbitTbl[row-1].from_Hash(value);
		...
		def create_dialog
			html_file = File.join(__dir__, 'html', 'DrillBits.html') # Use external HTML
			options = {
