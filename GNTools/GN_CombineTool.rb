...
require 'GNTools/GN_Hole.rb'
require 'GNTools/GN_StraitCut.rb'
require 'GNTools/GN_Pocket.rb'
...
module GNTools
	...
	module Paths
		...
		class CombineDialog
			...
			def create_dialog
				html_file = File.join(__dir__, 'html', 'CombinePath.html') # Use external HTML
